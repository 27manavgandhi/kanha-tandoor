    ...
    <footer className="bg-black border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold bg-gradient-to-r from-tandoor-red to-tandoor-orange bg-clip-text text-transparent">
                  Khanha Tandoor
                </h3>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-sm">
              ...
              <li className="flex items-center space-x-2">
                ...
                <a href="mailto:Omshankartandoor@gmail.com" className="hover:text-tandoor-orange transition">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-500 text-sm">
          <p>&copy; {new Date().getFullYear()} Khanha Tandoor Manufacture. All rights reserved.</p>
